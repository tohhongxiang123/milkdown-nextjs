...
const RichMarkdownEditor = ({ initialContentJSON, editable = true, enableMenu = true }: any) => {
    const { editor } = useRichMarkdownEditor({ initialContentJSON, editable, enableMenu })
